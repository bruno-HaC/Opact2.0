...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: 2lNfypwHEvw9/css
...
function PlasmicStatistic__RenderFunc(props: {
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__ms3N)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__swbJ3, {
                [sty.imghideIcon__swbJ3UqMgs]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__icp78)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__zapR, {
            [sty.freeBoxhideIcon__zapRUqMgs]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__lDd8D)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__g2YQ6, {
              [sty.freeBoxhideTrendTracker__g2YQ6JsE97]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox__oodUn, {
                [sty.freeBoxhideTrendTracker__oodUnJsE97]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__aPTv)}>
                {p.renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__iZfQp)}>
              <div className={classNames(projectcss.all, sty.freeBox__sMkYw)}>
                {p.renderPlasmicSlot({
