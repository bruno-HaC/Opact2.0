...
import sty from "./PlasmicDateTimeRangePicker.module.css"; // plasmic-import: 7N8ajMponD-P/css
            ...
            <React.Fragment>
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__uuLgT
                  ),
                  picker: "date",
                  popupScopeClassName:
                    sty["dateTimePicker__uuLgT__datePickerPopup"],
                  showTime: false
                };
              ...
              {(() => {
                const child$Props = {
                  ...
                  className: classNames(
                    "__wab_instance",
                    sty.dateTimePicker__wu2Jc
                  ),
                  popupScopeClassName:
                    sty["dateTimePicker__wu2Jc__datePickerPopup"],
                  showTime: false
                };
